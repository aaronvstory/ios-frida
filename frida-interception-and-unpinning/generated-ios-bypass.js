...
console.log("[+] Target Version: 17.6.1");
console.log("[+] CFNetwork: 1490.0.4");
console.log("[+] Darwin: 23.6.0");

// Configuration from template
const TARGET_IOS = "17.6.1";
const TARGET_CFNETWORK = "1490.0.4";
const TARGET_DARWIN = "23.6.0";
const TARGET_BUILD = "21G93";
...
if (ObjC.available) {
    ...
    try {
        ...
        Interceptor.attach(NSURLComponents['- queryItems'], {
            onLeave: function (retval) {
                if (!retval.isNull()) {
